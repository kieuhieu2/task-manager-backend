...
public interface TaskMapper {
    ...
    TaskResponse toTaskResponse(Task task, TaskState userState, Boolean isCreator, Integer positionInColumn, Integer percentDone);
    ...
    default TaskResponse toTaskResponse(Task task, TaskState userState, Boolean isCreator) {
        return toTaskResponse(task, userState, isCreator, null, null);
    }
